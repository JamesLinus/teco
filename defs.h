...
/* q-register pointer/macro stack entry */
struct qp {
...
/* structure of input file info */
struct infiledata {
    FILE *fd;		/* file pointer */
    int eofsw;		/* end-of-file switch */
};

/* structure of output file info */
struct outfiledata {
    FILE *fd;			/* file pointer */
...
/* pointer to currently active intput file structure */
extern struct infiledata *infile;

/* pointer to currently active output file structure */
extern struct outfiledata *outfile;
...
/* current, last, temp buffer position */
extern int dot, z, tdot;
...
/* pointer to temp text buffer during insert */
...
/* char mapping tables */
extern char mapch[], mapch_l[];

/* special character table */
extern char spec_chars[];

/* routines that return chars */
extern char skipto(),  getcmdc(), getcmdc0();

extern FILE *eisw;	/* indirect command file pointer */
extern FILE *fopen();


/* buffcell free-list pointer */
extern struct buffcell *freebuff;
...
/* Functions defined in one file, used in another */
