...
/* for q regs, command, search, file, sys-command, time/date */
struct qh qreg[NQREGS+5];
...
struct buffcell
    *insert_p;  	/* pointer to temp buffer segment during insert */
